...
:kfv-name: Faraz Vahedi
:kfv-email: kfv@FreeBSD.org
:kfv: {kfv-name} <{kfv-email}>
...
:mchoo-name: Minsoo Choo
:mchoo-email: mchoo@FreeBSD.org
:mchoo: {mchoo-name} <{mchoo-email}>
...
// FreeBSD Bugmeister
:bugmeister: {linimon}, {siva}, {ziaee}

// FreeBSD Core Team
:core-members: {adamw}, {adrian}, {bapt}, {glebius}, {hrs}, {imp}, {jrm}, {kevans}, {olivier}
:core-secretary-email: core-secretary@FreeBSD.org

// FreeBSD Doc Engineering Team
:doceng-members: {blackend}, {hrs}, {ebrandi}, {ziaee}
...
:srcmgr-members: {des}, {emaste}, {jhb}, {markj}
:srcmgr-lurkers: {bnovkov}, {imp}, {jfree}, {olce}, {siva}
