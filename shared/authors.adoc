...
:portmgr-members: {mat}, {antoine}, {bapt}, {bdrewery}, {rene}, {swills}, {tcberner}

// FreeBSD Release Engineering Teams
:re: re@FreeBSD.org
:re-members: {gjb}, {kib}, {bdrewery}, {blackend}, {delphij}, {cperciva}, {hrs}
:re-members-email: {gjb-email}, {kib-email}, {bdrewery-email}, {blackend-email}, {delphij-email}, {cperciva-email}, {hrs-email}
