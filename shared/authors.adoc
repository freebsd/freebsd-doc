...
// FreeBSD Core Team
:core-members: {allanjude}, {dch}, {glebius}, {hrs}, {lwhsu}, {mat}, {olivier}, {tcberner}
...
:re: re@FreeBSD.org
:re-members: {dch}, {blackend}, {delphij}, {emaste}, {cperciva}, {bofh}, {ivy}
:re-members-email: {dch-email}, {blackend-email}, {delphij-email}, {emaste-email}, {cperciva-email}, {bofh-email}, {ivy-email}
