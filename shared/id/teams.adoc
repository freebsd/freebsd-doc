...
:admins-name: Administrator FreeBSD
:admins-email: admins@FreeBSD.org
:admins: {admins-name} <{admins-email}>

:bugmeister-name: Administrator Basis Data Laporan Masalah
