...
:de-doc-email: de-bsd-translators@de.FreeBSD.org
:de-doc: {de-doc-desc} <{de-doc-email}>

:de-questions-desc: Fragen und Antworten zu FreeBSD
:de-questions-email: de-bsd-questions@de.FreeBSD.org
:de-questions: {de-questions-desc} <{de-questions-email}>

// Die Originale

:freebsd-acpi-desc: FreeBSD ACPI
:freebsd-acpi-url: http://lists.FreeBSD.org/mailman/listinfo/freebsd-acpi
:freebsd-acpi: {freebsd-acpi-url}[{freebsd-acpi-desc}]

:freebsd-advocacy-desc: FreeBSD advocacy
...
:freebsd-aic7xxx-desc: FreeBSD Adapteci AIC7xxx discussions
...
:freebsd-announce-desc: FreeBSD announcements
...
:freebsd-apache-desc: FreeBSD Apache
...
:freebsd-bugbusters-desc: FreeBSD bugbusters
...
:freebsd-cluster-desc: FreeBSD clustering
...
:freebsd-current-desc: FreeBSD-CURRENT
...
:ctm-src-4-desc: CTM 4-STABLE src branch distribution
...
:freebsd-desktop-desc: FreeBSD als Desktop verwenden und verbessern
...
:freebsd-doc-desc: FreeBSD documentation project
...
:freebsd-eclipse-desc: FreeBSD users of Eclipse EDI, tools, rich client apps and ports.
...
:freebsd-emulation-desc: FreeBSD-emulation
...
:freebsd-firewire-desc: FreeBSD FireWire (IEEE 1394) discussion
...
:freebsd-fs-desc: FreeBSD filesystem project
...
:freebsd-geom-desc: FreeBSD GEOM
...
:freebsd-gnome-desc: FreeBSD GNOME and GNOME applications
...
:freebsd-hackers-desc: FreeBSD technical discussions
...
:freebsd-hardware-desc: FreeBSD hardware and equipment
...
:freebsd-multimedia-desc: FreeBSD multimedia
...
:freebsd-new-bus-desc: New Bus Architecture
...
:freebsd-performance-desc: FreeBSD performance
...
:freebsd-perl-desc: FreeBSD Perl
...
:freebsd-platforms-desc: FreeBSD non-Intel platforms porting
...
:freebsd-ports-desc: FreeBSD ports
...
:freebsd-ports-bugs-desc: FreeBSD ports bugs
...
:freebsd-ppc-desc: FreeBSD PowerPC porting
...
:freebsd-questions-desc: FreeBSD general questions
...
:freebsd-realtime-desc: FreeBSD realtime extensions
...
:freebsd-security-notifications-desc: FreeBSD security notifications
...
:freebsd-sparc64-desc: FreeBSD SPARC porting
...
:freebsd-stable-desc: FreeBSD-STABLE;
...
:freebsd-standards-desc: FreeBSD C99 and POSIX compliance
...
:svn-doc-svnadmin-desc: SVN commit messages for the admin / configuration tree
...
:freebsd-test-desc: FreeBSD test
...
:freebsd-threads-desc: FreeBSD threads
...
:freebsd-tokenring-desc: FreeBSD tokenring
...
:freebsd-toolchain-desc: FreeBSD integrated toolchain
...
:freebsd-vendors-desc: FreeBSD vendors pre-release coordination
...
:freebsd-vuxml-desc: Diskussion über die Infrastruktur von VuXML
...
:freebsd-www-desc: FreeBSD Webmaster
...
:freebsd-alpha-desc: FreeBSD Alpha porting
