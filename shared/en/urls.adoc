...
// sites
:manual-site: https://man.freebsd.org/
...
:freebsd-src-lsp: {main-site}/articles/freebsd-src-lsp/
:freebsd-status-report-process: {main-site}/articles/freebsd-status-report-process/
