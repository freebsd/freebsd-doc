...
// Azerbaijan mirrors
:mirrors-azerbaijan-ftp1: ftp://ftp1.az.FreeBSD.org/pub/FreeBSD/
:mirrors-azerbaijan-ftp1-http: http://ftp1.az.FreeBSD.org/
:mirrors-azerbaijan-ftp1-rsync: rsync://ftp1.az.FreeBSD.org/
:mirrors-azerbaijan-email: orkhan@our.az
:mirrors-azerbaijan: Azerbaijan
