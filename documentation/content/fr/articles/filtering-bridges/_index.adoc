...
Maintenant il est nécessaire de compiler et d'installer le nouveau noyau. Vous pourrez trouver des instructions détaillées dans la section extref:{handbook}kernelconfig/[Compiler et installer un noyau sur mesures, kernelconfig-building] du Manuel de FreeBSD.
