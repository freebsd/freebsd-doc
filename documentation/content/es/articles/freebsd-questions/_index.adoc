...
También hay una serie de extref:{handbook}eresources[listas de correo especializadas, eresources-mail], que atienden a intereses más específicos. Los criterios anteriores se aplican, y es de su interés atenerse a ellos, ya que es más probable que obtenga buenos resultados de esa manera.
...
* Lea las páginas del manual y la documentación de FreeBSD (ya sea la instalada en [.filename]#/usr/doc# o accesible a través de WWW en extref:{handbook}[http://www.FreeBSD.org]), especialmente el manual y las extref:{faq}[FAQ].
