...
[[vinum-latency]] Considera una transferencia típica de unos 10 kB: la
generación actual de discos de alto rendimiento pueden situar los cabezales en
unos 3.5 ms de media. Los discos más rápidos giran a 15,000 rpm, así que la
latencia rotacional media (media revolución) es 2 ms. A 70 MB/s, la propia
transferencia tarda unos 150 #s, casi nada comparado con el tiempo de
posicionamiento. En ese caso, la tasa efectiva de transferencia cae hasta un
