...
| Iran icon:envelope[link=mailto:{mirrors-iran-email}, title="mirror contact"]
| ftp.ir.FreeBSD.org
| link:http://ftp.ir.freebsd.org/FreeBSD[http] link:http://ftp.ir.freebsd.org/FreeBSD[http_v6] link:ftp://ftp.ir.freebsd.org/FreeBSD[ftp] link:ftp://ftp.ir.freebsd.org/FreeBSD[ftp_v6] link:rsync://ftp.ir.freebsd.org/FreeBSD[rsync] link:rsync://ftp.ir.freebsd.org/FreeBSD[rsync_v6]
