...
Current locations are Australia, Brazil, Germany, Japan (two sites), Malaysia, South Africa, Taiwan, United Kingdom, United States of America (California, New Jersey, and Washington).
...
| **www.FreeBSD.org** / **docs.FreeBSD.org**
| `https`
| link:https://www.freebsd.org/[FreeBSD Web Site] and the link:https://docs.freebsd.org/[FreeBSD Documentation Portal].
|===
