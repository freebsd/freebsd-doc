...
| ftp.ir.FreeBSD.org
| link:http://ftp.ir.FreeBSD.org/FreeBSD[http] link:http://ftp.ir.FreeBSD.org/FreeBSD[http_v6] link:rsync://ftp.ir.FreeBSD.org[rsync] link:rsync://ftp.ir.FreeBSD.org[rsync_v6]
