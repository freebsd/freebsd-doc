...
This chapter demonstrates how to install popular vironments as well as desktop applications such as web browsers, productivity software, document viewers, and financial software.
...
This section describes how to install and configure some popular vironments on a FreeBSD system.
A vironment can range from a simple window manager to a complete suite of desktop applications.
