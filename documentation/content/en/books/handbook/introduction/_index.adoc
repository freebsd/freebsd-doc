...
* _Binary compatibility_ with Linux, which makes it possible to run many Linux binaries without the need for virtualization.
...
Be aware that some of the localized versions might be out of date and might contain information that is no longer correct or relevant.
