...
* link:http://www.sony.com/[Sony] - The PlayStation 3, PlayStation Vita, PlayStation 4, and PlayStation 5 gaming consoles run a modified version of FreeBSD.
...
* link:https://www.midnightbsd.org[MidnightBSD] is a FreeBSD-derived operating system developed with desktop users in mind. It includes all the software you would expect for your daily tasks: mail, web browsing, word processing, gaming, and much more.
