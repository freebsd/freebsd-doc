...
Welcome to FreeBSD! This handbook covers the installation and day to day use of _FreeBSD {rel150-current}-RELEASE_, _FreeBSD {rel144-current}-RELEASE_ and _{rel135-current}-RELEASE_.
