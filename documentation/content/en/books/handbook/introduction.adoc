...
Welcome to FreeBSD! This handbook covers the installation and day to day use of _FreeBSD {rel151-current}-RELEASE_, _FreeBSD {rel145-current}-RELEASE_ and _{rel135-current}-RELEASE_.
