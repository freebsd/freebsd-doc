...
Welcome to FreeBSD! This handbook covers the installation and day to day use of _FreeBSD {rel130-current}-RELEASE_, _FreeBSD {rel123-current}-RELEASE_ and _FreeBSD {rel114-current}-RELEASE_.
