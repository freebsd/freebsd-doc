...
tags: ["documentation", "FreeBSD-CURRENT", "FreeBSD-RELEASE", "FreeBSD-STABLE", "pkgbase", "Security Patches", "updating", "upgrading"]
showBookMenu: true
weight: 30
params:
...
Save a list of non-base packages:
...
The list might be useful if an interruption, such as loss of power, occurs during an upgrade.

Also, perform a package database backup: 
...
==== Performing Minor version upgrades
...
| releng/14.2
| twice daily – 12:00 and 00:00 UTC
| pkg+https://pkg.freebsd.org/${ABI}/base_release_2
