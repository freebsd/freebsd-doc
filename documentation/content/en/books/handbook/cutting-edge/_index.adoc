...
[WARNING]
====
After each new `RELEASE`, FreeBSD package build servers will, for a limited period, *not* use the newest version of the operating system.
...
kernel configuration distributed as part of FreeBSD 13.2-RELEASE.
