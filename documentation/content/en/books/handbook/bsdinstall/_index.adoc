...
[TIP]
====
Consider using crossref:virtualization[virtualization,virtualization] when wanting to use FreeBSD on a system that already has another operating system installed, or if you are unfamiliar with FreeBSD.
====
...
This procedure will erase the existing data on the USB stick.
====
