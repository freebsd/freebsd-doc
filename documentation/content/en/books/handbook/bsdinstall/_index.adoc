...
For example: `CHECKSUM.SHA256-FreeBSD-14.3-RELEASE-amd64` and `CHECKSUM.SHA512-FreeBSD-14.3-RELEASE-amd64`.
...
[source,shell]
....
% sha256sum -c CHECKSUM.SHA256-FreeBSD-14.3-RELEASE-amd64 FreeBSD-14.3-RELEASE-amd64-dvd1.iso
...
[source,shell]
....
# dd if=FreeBSD-14.3-RELEASE-amd64-memstick.img of=/dev/da0 bs=1M conv=sync
....
+
