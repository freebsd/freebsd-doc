...
Then, after rebooting, you'll be able to list available console video modes and select one with `vidcontrol`. For example:
...
If you are using a foreign keyboard, you may previously need to set it with `kbdcontrol`. For example, in order to set a French keyboard do:
