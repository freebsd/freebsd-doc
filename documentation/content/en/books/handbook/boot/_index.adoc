...
[NOTE]
====
There's :faq:[a frequently asked question] about GRUB. Beyond the answer there, users of GRUB should please refer to https://www.gnu.org/software/grub/grub-documentation.html[GNU-provided documentation]. 
====
