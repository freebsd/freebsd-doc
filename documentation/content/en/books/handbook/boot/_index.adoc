...
path: "/books/handbook/"
aliases: [
"/en/books/handbook/boot-introduction/",
"/en/books/handbook/boot-splash/",
"/en/books/handbook/device-hints/",
"/en/books/handbook/boot-shutdown/"
]
---
...
[NOTE]
====
// There's extref:{faq}[a frequently asked question] about GRUB. Beyond the answer there, //
Users of GRUB should please refer to https://www.gnu.org/software/grub/grub-documentation.html[GNU-provided documentation]. 
====
