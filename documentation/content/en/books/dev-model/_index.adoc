...
It is based on [<<thesis, Saers,2003>>].
...
In this figure, -STABLE refers to 4-STABLE while -CURRENT refers to 5.0-CURRENT following 5.0-RELEASE. [<<freebsd-releng, FreeBSD, 2002E>>]
...
The Documentation project has link:{fdp-primer}[a primer].
