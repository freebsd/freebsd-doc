...
Explicit calls for status reports will be sent to remind the deadlines.
...
That is, barring typos or other light copyediting, the status team should be able to assemble the submissions starting from the 15th.
