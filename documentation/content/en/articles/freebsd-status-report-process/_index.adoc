...
The months of January, April, July and October are dedicated to putting together the reports submitted during the precedent quarter.
Reports for the finished quarter are still accepted within the first 14 days of the month, but not later.
Status reports publication is done during the same months as soon as the report are ready.

Explicit calls for status reports will be sent with deadline reminders.
...
That is, barring typos or other light copyediting, the status team should be able to assemble the submissions starting on the 15th.
...
|Submissions deadline and third-party review slush
|April 14th
|July 14th
|October 14th
|January 14th
...
It can also be used through cron jobs, for example:
...
[IMPORTANT]
====
If you are in charge of sending calls for status reports and you are indeed using a cron job, please run it on freefall and sign it with your name so that it is possible to infer who has configured the cron job, in case something goes wrong.
