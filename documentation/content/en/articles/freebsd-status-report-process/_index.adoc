...
An AsciiDoc report template is available:

* https://github.com/freebsd/freebsd-doc/tree/main/website/content/en/status/report-sample.adoc[]
* https://reviews.freebsd.org/source/doc/browse/main/website/content/en/status/report-sample.adoc[]
