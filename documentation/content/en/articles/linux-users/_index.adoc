...
Instead, FreeBSD uses the Bourne shell-compatible man:sh[1] as the default user shell.
...
A complete list of all available ports and packages can be found https://ports.freebsd.org[here].
