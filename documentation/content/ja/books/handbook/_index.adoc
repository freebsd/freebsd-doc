...
FreeBSD へようこそ! このハンドブックは __FreeBSD {rel130-current}-RELEASE__, __FreeBSD {rel122-current}-RELEASE__ および __FreeBSD {rel114-current}-RELEASE__ のインストールと日常での使い方について記述したものです。
