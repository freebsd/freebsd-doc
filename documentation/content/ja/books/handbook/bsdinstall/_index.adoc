...
[NOTE]
====
グラフィカルなインストーラで FreeBSD をインストールしたいと考えているユーザは、 link:https://www.furybsd.org[FuryBSD], link:https://ghostbsd.org[GhostBSD] もしくは link:https://www.midnightbsd.org[MidnightBSD] に興味を持たれるでしょう。
====
