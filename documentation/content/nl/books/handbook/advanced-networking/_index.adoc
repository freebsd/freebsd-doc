...
Voor een goed begrip van seriële apparaten dient de tutorial extref:{serial-uart}[FreeBSD Serial Hardware] en de verschillen tussen asynchrone en synchrone seriële poorten gelezen te worden.
