---
title: 如何在 FreeBSD-questions mailing list 上得到正解
authors:
  - author: Greg Lehey
...
= 如何在 FreeBSD-questions mailing list 上得到正解
:doctype: article
:toc: macro
:toclevels: 1
:icons: font
...
本文主要是給準備寫信到 FreeBSD-questions mailing list 的人提供一些參考。 我們會給你一些發問的技巧與建議，以便讓你的答案得到更有用的答覆。
...
If you have done this, and you still can not figure out what is going on, send a message to mailto:freebsd-questions-request@FreeBSD.org[freebsd-questions-request@FreeBSD.org], and they will sort things out for you. _Do not_ send a message to FreeBSD-questions: they can not help you.
...
* Use a search engine such as http://www.google.com[Google] or http://www.yahoo.com[Yahoo] to find answers to your question. Google even has a http://www.google.com/bsd[BSD-specific search interface]. 
...
+ 
As you can see, the mailers in the Microsoft world are frequent offenders. If at all possible, use a UNIX(R) mailer. If you must use a mailer under Microsoft environments, make sure it is set up correctly. Try not to use MIME: a lot of people use mailers which do not get on very well with MIME.
