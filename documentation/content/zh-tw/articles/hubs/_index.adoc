...
Furthermore, admins should be subscribed to the http://lists.FreeBSD.org/mailman/listinfo/freebsd-hubs[FreeBSD mirror sites mailing lists]. See extref:{handbook}eresources[this link, eresources-mail] for details, how to subscribe.
