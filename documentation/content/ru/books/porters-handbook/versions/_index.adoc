...
.Значения `__FreeBSD_version` в FreeBSD 16
...
|29 сентября 2025
|16.0-CURRENT после изменений в LinuxKPI PCI.

|1600002
|gitref:37ad1beaf516854d5e59b90a9706b09d02cc2a81[repository="src",length=12]
|20 октября 2025
|16.0-CURRENT после изменений размера встроенной структуры LinuxKPI.

|1600003
|gitref:7eb213614b90cde31707a53c4b8ae6acacf2aa0f[repository="src",length=12]
|30 октября 2025
|16.0-CURRENT после изменения API `bus_alloc_resource`, чтобы передавать параметр `rid` по значению.

|1600004
|gitref:b3de3c2dea576b626a8a107d96b0fd6562500c1e[repository="src",length=12]
|2 ноября 2025
|16.0-CURRENT после добавления поддержки `_PC_CASE_INSENSITIVE` для NFS.
...
|9 декабря 2025
|16.0-CURRENT после изменения метода шинного драйвера `BUS_ALLOC_RESOURCE` для передачи аргумента `rid` по значению и после ZFS удалила libutil

|1600006
|gitref:c10447a9256b561bf2edf26b5abf5f28071a15c7[repository="src",length=12]
|15 декабря 2025
|16.0-CURRENT после добавления `BIOCGETIFLIST` ioctl в bpf(4).

|1600007
|gitref:1a26b161d829c9b52fec87fe44b4db50e8f046ff[repository="src",length=12]
|18 декабря 2025
|16.0-CURRENT после добавления vmap_pfn() в Linuxolator.

|1600008
|gitref:66eedcb0224df03e56513f3caf1df93a52b6a919[repository="src",length=12]
|13 января 2026
|16.0-CURRENT после того, как ABI struct sdt_probe была нарушена для исправления типа probe ID.

|1600009
|gitref:22569a1d80203bd4835a1d5d4660de5dbe334509[repository="src",length=12]
|16 января 2026
|16.0-CURRENT после изменения интерфейса политики mac(9) для включения точек входа для операций с клетками.

|1600010
|gitref:ac5a19ec6989675c8ec6c3ca245dba243d1a6416[repository="src",length=12]
|23 января 2026
|16.0-CURRENT после изменения xdrproc_t на всегда принимающий два аргумента.

|1600011
|gitref:d185e9fae91a48041363e36a6ee4a2a9c567fc16[repository="src",length=12]
|25 января 2026
|16.0-CURRENT после изменений в API eventfd, которые раскрывают этот API в linuxkpi для драйверов DRM.
...
|1 февраля 2025
|15.0-CURRENT после перевода сервисов ядра RPC на использование netlink.
...
|19 февраля 2025
|15.0-CURRENT после добавления `shrinker_alloc` и `shrinker_free` в LinuxKPI.

|1500034
|gitref:6ba1c5abb9575aaf4ef0a7efb085d42be252e645[repository="src",length=12]
|3 марта 2025
|15.0-CURRENT после изменения ABI между man:ipfw[4] и man:ipfw[8].

|1500035
|gitref:d5c804138845a1c8d81fbbce48de676806de32e6[repository="src",length=12]
|26 марта 2025
|15.0-CURRENT после добавления отсутствующих символов в карты символов библиотеки Heimdal.

|1500036
|gitref:85967694b4590a436c56a061b397620e342784ae[repository="src",length=12]
|9 апреля 2025
|15.0-CURRENT после изменения связи между мостами и `struct ifnet`
...
|6 мая 2025
|15.0-CURRENT после удаления поля `memq` из `struct vm_object`.

|1500042
|gitref:2fa185f9bf5948ead9c3920d452ddd6bcad8f569[repository="src",length=12]
|9 мая 2025
|15.0-CURRENT после устаревания флага `CRYPTO_F_DONE` в OCF.

|1500043
|gitref:a1215090416b8afb346fb2ff5b38f25ba0134a3a[repository="src",length=12]
|15 мая 2025
|15.0-CURRENT после добавления более строгой проверки формата адреса в `link_addr`.

|1500044
|gitref:0ec732913fceb9aae2d56c2dd667203711b76550[repository="src",length=12]
|28 мая 2025
|15.0-CURRENT после добавления `PCB_TLSBASE` на amd64.
...
|8 июня 2025
|15.0-CURRENT после удаления поля `listq` from `struct vm_page`.

|1500047
|gitref:29d0bcfd07e366bb5cf55b63419c3976f0a80bd6[repository="src",length=12]
|15 июня 2025
|15.0-CURRENT после импорта MIT Kerberos.

|1500048
|gitref:e3a4b989d7f7d82f7ab8cefe0d665dbe6b74d316[repository="src",length=12]
|17 июня 2025
|15.0-CURRENT после перехода на 256 отдельных очередей выполнения.
...
|5 июля 2025
|15.0-CURRENT после добавления поддержки настройки фильтрации vlan для участников моста.

|1500052
|gitref:ff2dc0bca3728448284d757ca983d023da7279b5[repository="src",length=12]
|16 июля 2025
|15.0-CURRENT после добавления kva_layout и удаления DMAP_MIN/MAX_ADDRESS.
...
|21 июля 2025
|15.0-CURRENT после перехода с Heimdal на MIT Kerberos.

|1500055
|gitref:dd0ec030f8fddfd109b860ae8df2b29fa0c60f23[repository="src",length=12]
|7 июля 2025
|15.0-CURRENT после добавления управления версиями символов в библиотеки Kerberos.

|1500056
|gitref:4befc6711ab25912c3378afe5a2989945acf803f[repository="src",length=12]
|30 июля 2025
|15.0-CURRENT после перемещения `cr_gid` из `cr_groups` в структуре `struct ucred`.

|1500057
|gitref:b3340428f394d08b9776899c7f6dc16ed5fd590c[repository="src",length=12]
|7 августа 2025
|15.0-CURRENT после добавления управления версиями символов в libutil.

|1500058
|gitref:4c6c27d3fb4ad15931aae2eaf8e624aed99a3fd9[repository="src",length=12]
|8 августа 2025
|15.0-CURRENT после добавления поддержки TBI на arm64.

|1500059
|gitref:db7c0e32a05dd7011553321e82ac66dd712eaf09[repository="src",length=12]
|9 августа 2025
|15.0-CURRENT после импорта OpenSSL 3.5.1.

|1500060
|gitref:f13e8ea08310fe8a0d8bc7817ae428939f8e5144[repository="src",length=12]
|13 августа 2025
|15.0-CURRENT после добавления `gpiobus_add_bus` и удаления `gpiobus_attach_bus`.

|1500061
|gitref:dd22a6853d92e4b94431988cb1d7a5fa498d24ab[repository="src",length=12]
|16 августа 2025
|15.0-CURRENT после изменения `getgroups` и `setgroups` для работы только с дополнительными группами.
...
|1 мая 2026
|15.1-STABLE после переименования из 15.1-PRERELEASE.

|1501501
|gitref:7fa638d6f7cf9ee471648a794756cb9d0aa289ba[repository="src",length=12]
|30 мая 2026
|15.1-STABLE после обновления llvm, clang, compiler-rt, libc++, libunwind, lld, lldb и openmp до llvmorg-21.1.8-0-g2078da43e25a, также известного как релиз 21.1.8.
...
|2 мая 2025
|14.3-STABLE после переименования из 14.3-PRERELEASE.

|1403501
|gitref:37303e96528e3c4662a464cfc778ddaa5194a3d1[repository="src",length=12]
|20 мая 2025
|14.3-STABLE после добавления более строгой проверки формата адреса в `link_addr`.

|1403502
|gitref:b7291e0da6ff485854ba07a0f8e18fb7b60ef5ba[repository="src",length=12]
|12 июня 2025
|14.3-STABLE после добавления `PCB_TLSBASE` на amd64.
...
|28 июля 2025
|14.3-STABLE после перехода на 256 отдельных очередей выполнения.

|1403505
|gitref:4f22d274ab0d1da23c000e4f7f2ea003c5fa94a7[repository="src",length=12]
|23 августа 2025
|14.3-STABLE после добавления аргумента `xattrsupp` в `nfsv4_fillattr`.

|1403506
|gitref:4612f5f2d23348c8a861834d4c9f98b0a2742f56[repository="src",length=12]
|28 августа 2025
|14.3-CURRENT после добавления VTYPE_ISDEV(), VN_ISDEV() и VATTR_ISDEV().

|1403507
|gitref:108b5d90bc1fa8ed83cfd6f58e636193e03e8049[repository="src",length=12]
|18 декабря 2025
|14.3-STABLE после изменения API `bus_alloc_resource`, чтобы передавать параметр `rid` по значению.

|1403508
|gitref:16e2bb8177bd86a954ef968551d8c8980582381a[repository="src",length=12]
|16 января 2026
|14.3-STABLE после различных изменений в LinuxKPI.

|1404500
|gitref:567cb65a378f36caba79672fd72c961b2c99a132[repository="src",length=12]
|6 февраля 2026
|14.4-STABLE после переименования из 14.4-PRERELEASE.

|1404501
|gitref:47f4f76074a48cdaa743f05929725c84f71d502b[repository="src",length=12]
|30 мая 2026
|14.4-STABLE после обновления llvm, clang, compiler-rt, libc++, libunwind, lld, lldb и openmp до llvmorg-21.1.8-0-g2078da43e25a, также известного как релиз 21.1.8.
...
|15 марта 2019
|13.0-CURRENT после деанонимизации перечислений состояний потоков и процессов, что позволяет приложениям пользовательского пространства использовать их без переопределения имён значений.
...
|18 апреля 2019
|13.0-CURRENT после восстановления доступности man:random[4] с учётом компромиссов до link:https://svnweb.freebsd.org/changeset/base/346250[346250] и добавления новых настроек и диагностических sysctl для программного обнаружения проблем с ранней инициализацией семени после загрузки.
...
|29 мая 2019
|13.0-CURRENT после добавления поддержки перемещения в libdwarf на powerpc64 для исправления обработки DWARF-информации в несвязанных объектах. Оригинальный коммит по ссылке link:https://svnweb.freebsd.org/changeset/base/348347[348347].
...
|6 января 2020
|13.0-CURRENT после добавления собственного счетчика отменённых USB-передач.
...
|13 января 2020
|11-STABLE после добавления собственного счетчика для отменённых USB-передач.
...
|9 июля 2013
|10-CURRENT после миграции структур статистики на PCPU-счетчики. Изменённые структуры включают: `ahstat`, `arpstat`, `espstat`, `icmp6_ifstat`, `icmp6stat`, `in6_ifstat`, `ip6stat`, `ipcompstat`, `ipipstat`, `ipsecstat`, `mrt6stat`, `mrtstat`, `pfkeystat`, `pim6stat`, `pimstat`, `rip6stat`, `udpstat` (rev link:https://svnweb.freebsd.org/changeset/base/253081[253081]).
...
|9 августа 2013
|10-CURRENT после изменения подсистемы VM для объединения механизмов мягкой и жёсткой занятости.
...
|13 января 2020
|10-STABLE после добавления собственного счетчика для отменённых USB-передач.
|===
...
|13 августа 2005
|7.0-CURRENT после добавления аргумента учётных данных в обработчик события `dev_clone`.
...
|10 июня 2007
|7.0-CURRENT после изменения man:pam_nologin[8] для предоставления функции управления учётными записями вместо функции аутентификации в рамках PAM.
...
|21 июня 2002
|4.6-STABLE man:sendfile[2] исправлен для соответствия документации, чтобы не учитывать отправленные заголовки в объёме данных, отправляемых из файла.
...
[[versions-2]]
== Версии FreeBSD 2 до 2.2-RELEASE
