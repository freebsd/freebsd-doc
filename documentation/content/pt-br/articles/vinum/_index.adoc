...
[WARNING]
====
vinum está obsoleto e não está presente no FreeBSD 15.0 e posteriores.
Os usuários são aconselhados a migrar para man:gconcat[8], man:gmirror[8], man:gstripe[8], man:graid[8], ou man:zfs[8].
====
