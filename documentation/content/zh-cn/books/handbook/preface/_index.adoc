...
* Vinum 卷管理（历史章节，已从当前手册中移除，相关功能已被 GEOM 和 ZFS 取代）。
...
2025 至 2026 年期间，FreeBSD-Ask项目（https://github.com/FreeBSD-Ask/Handbook）对本手册中文版进行了大量更新和翻译工作，特别是 ZFS、Wayland、Wine 等现代章节的内容同步。这些贡献已被整合进当前版本。
