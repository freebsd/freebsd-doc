...
<!-- $FreeBSD: www/zh_CN/index.xsl,v 1.1.1002.22 2006/05/23 17:02:10 delphij Exp $ -->
			...
			<div id="FRONTRELEASES">
			  <div id="FRONTRELEASESCONTENT" class="txtshortcuts">
				  ...
				  <ul id="FRONTRELEASESLIST">
					<li>
					  <a href="{$enbase}/{$u.rel.announce}">生产适用版 <xsl:value-of select="$rel.current"/></a>
					</li>
					<li>
					  <a href="{$enbase}/{$u.rel2.announce}">生产适用版(旧式) <xsl:value-of select="$rel2.current"/></a>
					</li>
