...
Ha az FTP kapcsolaton keresztüli letöltést választjuk, a kézikönyvben található link:{handbook}#mirrors-ftp[*tükörszerverek*] listájában keressük meg a hozzánk legközelebbi kiszolgálót.
