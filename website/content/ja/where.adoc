...
HTTP もしくは FTP 経由で FreeBSD をダウンロードする際には、 ハンドブックの link:{handbook}#mirrors-ftp[*ミラーサイト*] の一覧を見て、 あなたの地域に近いサイトを探してください。
...
FreeBSD の CD-ROM や DVD は、link:http://www.freebsdmall.com/[FreeBSD Mall] もしくは link:{handbook}#mirrors[CD-ROM および DVD の出版社] から購入できます。
