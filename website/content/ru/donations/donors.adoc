...
|`wilko, от имени Compaq` |DS10 |murray, obrien, кластер пакетов |Получено
...
|`Daniel <DS@praxisvermittlung24.de>,          Seuffert & Waidmann` |Модуль флеш-памяти 16Mb для Cisco |rik |Получено
