...
|===
|Установщик |Виртуальная машина |SD-карта |Документация
a|
...
a|
* {blank}
* link:../releases/#current[Релиз]: 2 декабря 2025
...
* link:../releases/15.0R/errata[Неисправности]
...
//
// Original EN revision (26.02.2026): 0f71ddbf2677a99106aff72e9bdb92c93c51f1c6
//
