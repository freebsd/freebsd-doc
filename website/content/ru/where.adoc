...
== Качество промышленной эксплуатации (исторические релизы)
...
a|
* link:../releases/#current[Дата релиза]: {rel135-current-date}
...
* link:{u-rel135-errata}[Исправления и дополнения]
...
FreeBSD можно приобрести на DVD у link:{handbook}mirrors/#mirrors-disc[издателей DVD].
...
//
// Original EN revision (07.03.2026): 75dea5f71f97a48dedb730635003e20f52f14182
//
