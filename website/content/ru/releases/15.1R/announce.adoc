...
Инженерная группа по выпуску FreeBSD с удовольствием сообщает о доступности FreeBSD {thisRelease}-RELEASE.
...
* Достигнут значительный прогресс в направлении полной поддержки версии C23 языка программирования C.
...
Дополнительную информацию о деятельности по выпуску релизов FreeBSD можно найти на странице:
...
dvd1::
Содержит всё необходимое для установки базовой операционной системы FreeBSD, документацию, отладочные наборы дистрибутива и небольшой набор предварительно собранных пакетов, предназначенных для запуска графической рабочей станции.
...
Будьте внимательны и убедитесь, что правильно указали целевое устройство (of=).
bootonly::
Поддерживает загрузку машины с привода CDROM, но не содержит наборов дистрибутива для установки FreeBSD непосредственно с CD.
...
Будьте внимательны и убедитесь, что правильно указали целевое устройство (of=).
mini-memstick::
Этот образ может быть записан на USB-флеш-накопитель и использован для загрузки машины, но не содержит наборов дистрибутива на самом носителе, аналогично образу bootonly.
Также поддерживает загрузку в режиме восстановления "livefs".
Предварительно собранных пакетов нет.
+
...
Многие компании предоставили оборудование, сетевой доступ или человеческое время для поддержки деятельности по выпуску релизов FreeBSD {thisRelease}, включая:
...
|Ed Maste <emaste@FreeBSD.org> |Заместитель руководителя инженерии выпуска
|Colin Percival <cperciva@FreeBSD.org> |Руководитель инженерии выпуска, Инженерия выпуска {thisRelease}-RELEASE
