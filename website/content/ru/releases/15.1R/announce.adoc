...
Некоторые архитектуры также поддерживают установку с флеш-накопителя USB.
...
+
Кроме того, этот образ может быть записан на флеш-накопитель USB для архитектуры amd64 и использован для установки на машинах, способных загружаться с USB-накопителей.
...
Будьте внимательны и убедитесь, что правильно указали целевое устройство (of=).
memstick::
Этот образ может быть записан на флеш-накопитель USB и использован для установки на машинах, способных загружаться с USB-накопителей.
Также поддерживает загрузку в режиме восстановления "livefs".
Предварительно собранных сторонних пакетов нет.
+
...
Будьте внимательны и убедитесь, что правильно указали целевое устройство (of=).
mini-memstick::
Этот образ может быть записан на флеш-накопитель USB и использован для загрузки машины, но не содержит дистрибутивных наборов на самом носителе, аналогично образу bootonly.
Также поддерживает загрузку в режиме восстановления "livefs".
Предварительно собранных пакетов нет.
+
