...
|Jake Freeland <jfree@FreeBSD.org> |Подготовка релиза
...
|Mahdi Mokhtari <mmokhi@FreeBSD.org> |Подготовка релиза
...
|Lexi Winter <ivy@FreeBSD.org> |Подготовка релиза, Ответственный за pkgbase
|===
