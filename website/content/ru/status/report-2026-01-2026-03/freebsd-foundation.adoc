...
ifndef::reports-path[]
* link:../alpha-omega-beach-cleaning[Проект Alpha-Omega Beach Cleaning]
* link:../fred[Поддержка FRED для amd64]
* link:../audio[Улучшения аудиостека]
* link:../desktop-script-bsdinstall[Десктопный скрипт для BSDInstall]
* link:../sbom[Спецификация программных компонентов FreeBSD]
* link:../bhyve-cpuid[Полный контроль над CPUID для bhyve]
* link:../hibernate[Гибернация (приостановка с сохранением состояния на диск)]
* link:../libvirt[Улучшение поддержки libvirt для гипервизора bhyve]
* link:../openjdk[Улучшение OpenJDK во FreeBSD]
* link:../kbench-maint-pkgdist[Бенчмарк ядра, MAINTAINERS и pkgdist]
* link:../laptop-integration[Проект тестирования и интеграции ноутбуков]
* link:../lkpi-wireless[Обновление LinuxKPI 802.11 и нативного беспроводного стека]
* link:../lldb[Улучшение LLDB во FreeBSD]
* link:../pkgbasify[Более надёжное преобразование pkgbase]
* link:../pdwait[Завершение разработки API дескрипторов процессов]
* link:../jumbograms[Удаление поддержки RFC 2675]
* link:../h616[Поддержка семейства SoC Allwinner H616]
