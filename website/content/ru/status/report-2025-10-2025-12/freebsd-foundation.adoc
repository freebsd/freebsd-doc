...
ifndef::reports-path[]
* link:../accessibility-handbook[Руководство по доступности]
* link:../alpha-omega-beach-cleaning[Проект генеральной уборки Alpha-Omega]
* link:../audio[Улучшения звукового стека]
* link:../osv[Конвертация VuXML в базу данных уязвимостей с открытым исходным кодом]
* link:../sbom[Спецификация программного обеспечения FreeBSD (Software Bill of Materials)]
* link:../bhyve-cpuid[Полный контроль CPUID для bhyve]
* link:../libvirt[Улучшение поддержки libvirt для гипервизора bhyve]
* link:../openjdk[Улучшение OpenJDK на FreeBSD]
* link:../lkpi-wireless[Обновление LinuxKPI 802.11 и нативного беспроводного стека]
* link:../suspend[Улучшения приостановки/возобновления работы]
...
ifdef::reports-path[]
<<_infrastructure_modernization,проекта модернизации инфраструктуры>>
endif::[] 
ifndef::reports-path[]
link:../foundation-sta[проекта модернизации инфраструктуры]
endif::[]
, заказанного link:https://www.sovereign.tech/[Sovereign Tech Agency].
