...
:url-cvs-readme: http://www.freebsd.org/cgi/cvsweb.cgi/~checkout~/src/share/examples/BSD_daemon/README?content-type=text/plain
...
{phk-name} 的 BSD Daemon 圖稿則是以 "`THE BEER-WARE LICENSE`" 發佈。 詳情請參閱 {url-cvs-readme}[README]
