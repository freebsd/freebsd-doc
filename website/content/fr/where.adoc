...
Si vous comptez télécharger FreeBSD via FTP, veuillez consulter la liste des link:{handbook}#mirrors-ftp[*sites miroirs*] du manuel de référence pour déterminer lequel est le plus proche de chez vous.
