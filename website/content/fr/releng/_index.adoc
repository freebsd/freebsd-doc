...
L'équipe principale est chargée d'accepter ou non les requêtes link:{faq}#_que_veut_dire_mfc[MFC] pendant les périodes où le code source ne doit plus être modifié, d'établir le calendrier des sorties et de toutes les autres responsabilités décrites dans notre link:charter[charte].
