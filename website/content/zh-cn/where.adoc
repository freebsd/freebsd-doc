...
a|
* link:../releases/#current[发行于]: {rel122-current-date}
* link:{u-rel122-notes}[发行公告]
* link:{u-rel122-readme}[自述文件]
* link:{u-rel122-hardware}[硬件兼容性列表]
* link:{u-rel122-installation}[安装说明]
* link:{u-rel122-errata}[勘误]
* link:{u-rel122-signatures}[已签名校验和]
