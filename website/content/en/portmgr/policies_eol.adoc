...
|stable/14 |n/a |releng/14.0 | |December 31, 2028 (Tentative)
|releng/14.0 |14.0-BETA4 |releng/14.0 a|
* FreeBSD:14:aarch64 (only latest is available)
* FreeBSD:14:amd64 (only latest is available)
* FreeBSD:14:armv6 (only latest is available)
* FreeBSD:14:armv7 (only latest is available)
* FreeBSD:14:i386 (only latest is available)
* FreeBSD:14:powerpc (only latest is available)
* FreeBSD:14:powerpc64 (only latest is available)
* FreeBSD:14:powerpc64le (only latest is available)
