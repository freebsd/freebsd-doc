...
|December 2026 |FreeBSD 15.2 |link:../releases/15.2R/schedule/[Target Schedule]
...
|`releng/14.5` |Frozen |security-officer@FreeBSD.org |FreeBSD 14.5 supported errata fix branch.
