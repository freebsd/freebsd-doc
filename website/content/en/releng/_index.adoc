...
|September 2024 |FreeBSD 13.4 |link:../releases/13.4R/schedule/[Target Schedule]
|December 2024 |FreeBSD 14.2 |link:../releases/14.2R/schedule/[Target Schedule]
|===
...
|`releng/13.4` |Frozen |re@FreeBSD.org |FreeBSD 13.4 supported errata fix branch.
