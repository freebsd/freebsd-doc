...
|December 2022 |FreeBSD 12.4 |link:../releases/12.4R/schedule/[Target Schedule]
|March 2023 |FreeBSD 13.2 |link:../releases/13.2R/schedule/[Target Schedule]
...
|`releng/13.0` |Frozen |security-officer@FreeBSD.org |FreeBSD 13.0 supported errata fix branch.
