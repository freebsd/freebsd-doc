...
//As of 2022-05-31, the next release has not yet been announced.

[.tblbasic]
[cols=",,",options="header",]
|===
|Date |Event |Information
|April 2023 |FreeBSD 13.2 |link:../releases/13.2R/schedule/[Target Schedule]
|July 2023 |FreeBSD 14.0 |link:../releases/14.0R/schedule/[Target Schedule]
|===
...
|`releng/13.1` |Frozen |security-officer@FreeBSD.org |FreeBSD 13.1 supported errata fix branch.
...
https://download-archive.freebsd.org/pub/FreeBSD-Archive/old-releases/[] includes source code and images, however it is not a complete archive. 

link:{handbook}mirrors/#mirrors-cdrom[Optical disc retailers] might provide older content that is not archived by the FreeBSD Project.
