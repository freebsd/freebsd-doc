...
The FreeBSD Source Management Team (also known as `srcmgr` due to its mailto:srcmgr@FreeBSD.org[email alias]) is responsible for issues relating to the base system.
...
Voting members: {srcmgr-members}

Lurkers: {srcmgr-lurkers}
