...
FreeBSD has participated as a mentoring organization every year since GSoC began in 2005, and we are applying again in 2026.
...
For inspiration, here are the projects wiki pages from previous years:
