...
<title>FreeBSD/i386 6.4-RELEASE Release Notes</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD/i386 6.4-RELEASE Release
Notes</a></h1>
...
<p>This document contains the release notes for FreeBSD 6.4-RELEASE on the i386 hardware
