...
<title>FreeBSD/alpha 6.4-RELEASE Hardware Notes</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD/alpha 6.4-RELEASE Hardware
Notes</a></h1>
...
<dd>
<dl>
<dt>2.1 <a href="#AEN30">Overview</a></dt>
...
<dt>2.3.2 <a href="#AEN187">Personal Workstation (&#8220;Miata&#8221;)</a></dt>

<dt>2.3.3 <a href="#AEN297">Evaluation Board 64 family</a></dt>

<dt>2.3.4 <a href="#AEN352">Evaluation Board 164 (&#8220;EB164, PC164, PC164LX,
PC164SX&#8221;) family</a></dt>

<dt>2.3.5 <a href="#AEN421">AlphaStation 200 (&#8220;Mustang&#8221;) and 400
(&#8220;Avanti&#8221;) series</a></dt>

<dt>2.3.6 <a href="#AEN488">AlphaStation 500 and 600 (&#8220;Alcor&#8221; &#38;
&#8220;Maverick&#8221; for EV5, &#8220;Bret&#8221; for EV56)</a></dt>

<dt>2.3.7 <a href="#AEN600">AlphaServer 1000 (&#8220;Mikasa&#8221;), 1000A
(&#8220;Noritake&#8221;) and 800(&#8220;Corelle&#8221;)</a></dt>

<dt>2.3.8 <a href="#AEN660">DS10/VS10/XP900 (&#8220;Webbrick&#8221;) / XP1000
(&#8220;Monet&#8221;) / DS10L (&#8220;Slate&#8221;)</a></dt>

<dt>2.3.9 <a href="#AEN811">DS20/DS20E (&#8220;Goldrush&#8221;)</a></dt>

<dt>2.3.10 <a href="#AEN881">AlphaPC 264DP / UP2000</a></dt>

<dt>2.3.11 <a href="#AEN927">AlphaServer 2000 (&#8220;DemiSable&#8221;), 2100
(&#8220;Sable&#8221;), 2100A (&#8220;Lynx&#8221;)</a></dt>

<dt>2.3.12 <a href="#AEN998">AlphaServer 4x00 (&#8220;Rawhide&#8221;)</a></dt>

<dt>2.3.13 <a href="#AEN1031">AlphaServer 1200 (&#8220;Tincup&#8221;) and AlphaStation
1200 (&#8220;DaVinci&#8221;)</a></dt>

<dt>2.3.14 <a href="#AEN1061">Alpha Processor Inc. UP1000</a></dt>

<dt>2.3.15 <a href="#AEN1110">Alpha Processor Inc. UP1100</a></dt>

<dt>2.3.16 <a href="#AEN1158">Alpha Processor Inc. CS20, Compaq DS20L</a></dt>

<dt>2.3.17 <a href="#AEN1205">Compaq AlphaServer ES40 (&#8220;Clipper&#8221;)</a></dt>
</dl>
</dd>

<dt>2.4 <a href="#AEN1242">Supported Hardware Overview</a></dt>

<dt>2.5 <a href="#AEN1273">Further reading</a></dt>

<dt>2.6 <a href="#AEN1277">Acknowledgments</a></dt>
</dl>
</dd>
...
Alpha/AXP hardware platform (also referred to as FreeBSD/alpha 6.4-RELEASE). It lists
...
<div class="SECT2">
<hr />
<h3 class="SECT2"><a id="AEN30" name="AEN30">2.1 Overview</a></h3>
...
typically can accommodate large to very large physical memory sizes, FreeBSD is limited
to 1 or 2 Gbytes (dependent on the core chipset) of RAM. This restriction is due to the
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN112" name="AEN112">2.3.1 AXPpci33
(&#8220;NoName&#8221;)</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN187" name="AEN187">2.3.2 Personal Workstation
(&#8220;Miata&#8221;)</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN297" name="AEN297">2.3.3 Evaluation Board 64 family</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN352" name="AEN352">2.3.4 Evaluation Board 164 (&#8220;EB164,
...
on the PC164. Symbios 53C896 has been confirmed to not work.</p>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN421" name="AEN421">2.3.5 AlphaStation 200
...
<ul>
<li>
<p>21064 or 21064A CPU at speeds of 100 up to 333 MHz</p>
</li>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN488" name="AEN488">2.3.6 AlphaStation 500 and 600
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN600" name="AEN600">2.3.7 AlphaServer 1000
...
hot-plug chassis. Instead, it has a disk cage that allows up to 4 fullheight 3.5" SCA
SCSI disks to be installed. The carriers used to mount the disks are specific to the
AlphaServer 800. The main difference between AS1000 and AS1000A is that AS1000A has 7 PCI
slots whereas AS1000 only has 3 PCI slots and has EISA slots instead.</p>

<p>The AlphaServer 800 system has a smart power controller. This means that parts of the
system remain powered when it is switched off (like an ATX-style PC power supply). Before
servicing the machine remove the power cord.</p>
...
<p>AlphaServer 800 with an EV5/400 MHz CPU was later re-branded to become a
&#8220;DIGITAL Server 3300[R]&#8221;, AlphaServer 800 with an EV5/500 MHz CPU was later
re-branded to become a &#8220;DIGITAL Server 3305[R]&#8221;.</p>
...
<li>
<p>AS800: Uses 60ns 3.3 Volts EDO DIMMs. 8 DIMM sockets are provided.</p>
</li>
</ul>
</li>
...
2GB. Note that it uses buffered EDO DIMMs.</p>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN660" name="AEN660">2.3.8 DS10/VS10/XP900
...
<div class="SECT4">
<hr />
<h5 class="SECT4"><a id="AEN666" name="AEN666">2.3.8.1 &#8220;Webbrick /
Slate&#8221;</a></h5>
...
mandatory to keep <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=config&sektion=8&manpath=FreeBSD+6.4-RELEASE">
...
<div class="SECT4">
<hr />
<h5 class="SECT4"><a id="AEN731" name="AEN731">2.3.8.2 &#8220;Monet&#8221;</a></h5>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN811" name="AEN811">2.3.9 DS20/DS20E
(&#8220;Goldrush&#8221;)</a></h4>
...
<ul>
<li>
<p>21264 EV6 CPU at 500, 667 or 833 MHz</p>
</li>
...
<li>
<p>L2 / Bcache: 4 Mbytes per CPU (500 MHz)</p>

<p>L2 / Bcache: 8 Mbytes per CPU (667 and 833 MHz)</p>
</li>
...
<li>
<p>embedded Adaptec AIC-7895 Wide Ultra SCSI</p>
</li>
...
is in a sleeker case, and lacks the StorageWorks shelf. It can either be rackmounted or
floorstanding.</p>

<p>The system has a smart power controller. This means that parts of the system remain
powered when it is switched off (like an ATX-style PC power supply). Before servicing the
machine remove all power cord(s).</p>
...
<p>The embedded Adaptec SCSI on the DS20 is disabled and is therefore not usable under
FreeBSD. On the DS20E with recent SRM console code you can use them with FreeBSD.</p>
...
dual channel LVD U160 SCSI, which is bootable from SRM. For a single channel LVD Ultra2
SCSI adapter you can use a LSI Logic / Symbios Sym8952u card.</p>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN881" name="AEN881">2.3.10 AlphaPC 264DP / UP2000</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN927" name="AEN927">2.3.11 AlphaServer 2000
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN998" name="AEN998">2.3.12 AlphaServer 4x00
(&#8220;Rawhide&#8221;)</a></h4>
...
interchangeably. Note that if you want remote power on/off to function you need to
connect a small DC adapter to the machine in order to have the RCM logic powered. You
need to supply 9-12V DC to the small inlet located next to the keyboard connector.</p>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1031" name="AEN1031">2.3.13 AlphaServer 1200
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1061" name="AEN1061">2.3.14 Alpha Processor Inc.
UP1000</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1110" name="AEN1110">2.3.15 Alpha Processor Inc.
UP1100</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1158" name="AEN1158">2.3.16 Alpha Processor Inc. CS20, Compaq
DS20L</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1205" name="AEN1205">2.3.17 Compaq AlphaServer ES40
(&#8220;Clipper&#8221;)</a></h4>
...
<div class="SECT2">
<hr />
<h3 class="SECT2"><a id="AEN1242" name="AEN1242">2.4 Supported Hardware Overview</a></h3>
...
reported not to work correctly with FreeBSD/alpha (although it works excellently on
FreeBSD/x86).</p>
...
<div class="SECT2">
<hr />
<h3 class="SECT2"><a id="AEN1273" name="AEN1273">2.5 Further reading</a></h3>

<p>An interesting overview of the history of the Alpha CPU can be found at <a
href="http://www.alasir.com/alpha/alpha_history.html"
target="_top">http://www.alasir.com/alpha/alpha_history.html</a>.</p>
</div>

<div class="SECT2">
<hr />
<h3 class="SECT2"><a id="AEN1277" name="AEN1277">2.6 Acknowledgments</a></h3>
