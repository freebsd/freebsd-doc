---
title: "FreeBSD/i386 6.4-RELEASE Installation Instructions"
sidenav: download
---
...
<p>This article gives some brief instructions on installing FreeBSD/i386 6.4-RELEASE,
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=doscmd&sektion=1&manpath=FreeBSD+6.4-RELEASE">
