---
title: "FreeBSD/pc98 6.4-RELEASE Hardware Notes"
sidenav: download
---
...
NEC PC-98x1 hardware platform (also referred to as FreeBSD/pc98 6.4-RELEASE). It lists
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=ct&sektion=4&manpath=FreeBSD+6.4-RELEASE"><span
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=snc&sektion=4&manpath=FreeBSD+6.4-RELEASE">
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=sb&sektion=4&manpath=FreeBSD+6.4-RELEASE"><span
