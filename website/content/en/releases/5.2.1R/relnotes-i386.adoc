---
title: "FreeBSD/i386 5.2.1-RELEASE Release Notes"
sidenav: download
---
...
<p>This document contains the release notes for FreeBSD 5.2.1-RELEASE on the i386
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=sconfig&amp;sektion=8&amp;manpath=FreeBSD+5.2.1-RELEASE">
...
<p><b>Warning:</b> This driver should be considered experimental and should be used with
some caution.</p>
</blockquote>
</div>
...
<p>[5.2.1] <tt class="FILENAME">cdboot</tt> now works around a BIOS problem observed on
some systems when booting from USB CDROM drives.</p>
</div>
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=asf&amp;sektion=8&amp;manpath=FreeBSD+5.2.1-RELEASE">
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=gdb&amp;sektion=1&amp;manpath=FreeBSD+5.2.1-RELEASE">
