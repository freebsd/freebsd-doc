---
title: "FreeBSD/sparc64 5.2-RELEASE Release Notes"
sidenav: download
---
...
<p>This document contains the release notes for FreeBSD 5.2-RELEASE on the UltraSPARC
...
target="_top">ftp://ftp.FreeBSD.org/pub/FreeBSD/development/sparc64/</a> or any of its
