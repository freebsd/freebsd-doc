---
title: "FreeBSD/i386 4.6-RELEASE Hardware Notes"
sidenav: download
---
...
++++
      ...
      <div class="SECT1">
        ...
        for FreeBSD 4.6-RELEASE on the IA-32 hardware platform
        (also referred to as FreeBSD/i386 4.6-RELEASE). It lists
