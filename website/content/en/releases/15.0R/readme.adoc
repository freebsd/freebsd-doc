---
title: "FreeBSD 15.0-RELEASE README"
sidenav: download
---
...
FreeBSD is an open source operating system derived from 4.4 BSD Lite2 for 64-bit x86-based PC hardware (amd64), 64-bit Arm(R) ARMv8-A AArch64 systems (aarch64), 32-bit Arm(R) ARMv7 systems (armv7), 64-bit PowerPC(R) systems (powerpc64, powerpc64le), and 64-bit RISC-V (riscv64) systems.
