...
**State**: reverted in main - https://bugs.freebsd.org/291511 +
...
5. **man:loader.efi[8]** has a regression preventing boot on some systems +
**Workaround**: set `console="eficom"` at the man:loader[8] prompt if it hangs when loading the kernel +
