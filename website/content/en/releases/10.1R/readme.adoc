---
title: "FreeBSD 10.1-RELEASE README"
sidenav: download
---
...
[.note]
*Note*: +
It is extremely important to read the errata for any given release before installing it, to learn about any "late-breaking news" or post-release problems. The errata file accompanying each release (most likely right next to this file) is already out of date by definition, but other copies are kept updated on the Internet and should be consulted as the "current errata" for this release. These other copies of the errata are located at the `FreeBSD 10.1-RELEASE page` (as well as any sites which keep up-to-date mirrors of this location).
