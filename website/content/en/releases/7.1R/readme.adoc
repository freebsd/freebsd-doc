...
<title>FreeBSD 7.1-RELEASE README</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD 7.1-RELEASE README</a></h1>
...
release/7.1.0/release/doc/en_US.ISO8859-1/readme/article.sgml 171891 2007-08-18 17:11:14Z
bmah $<br />
</p>
...
<p>This document gives a brief introduction to FreeBSD 7.1-RELEASE. It includes some
...
<p>This distribution is a release of FreeBSD 7.1-RELEASE, the latest point along the
7.1-STABLE branch.</p>
...
<p>If you're tracking the 7.1-STABLE development efforts, you <span class="emphasis"><i
...
different in FreeBSD 7.1-RELEASE compared to the previous release (FreeBSD
7.0-RELEASE).</p>
</li>
