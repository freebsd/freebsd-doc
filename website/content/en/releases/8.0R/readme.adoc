...
<title>FreeBSD 8.0-RELEASE README</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD 8.0-RELEASE README</a></h1>
...
release/8.0.0/release/doc/en_US.ISO8859-1/readme/article.sgml 179456 2008-05-31 13:45:35Z
hrs $<br />
</p>
...
<p>This document gives a brief introduction to FreeBSD 8.0-RELEASE. It includes some
...
<p>This distribution is a release of FreeBSD 8.0-RELEASE, the latest point along the
8.0-STABLE branch.</p>
...
<p>If you're tracking the 8.0-STABLE development efforts, you <span class="emphasis"><i
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=send-pr&sektion=1&manpath=FreeBSD+8.0-RELEASE">
...
different in FreeBSD 8.0-RELEASE compared to the previous release (FreeBSD
7.2-RELEASE).</p>
</li>
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=tuning&sektion=7&manpath=FreeBSD+8.0-RELEASE">
<span class="CITEREFENTRY"><span class="REFENTRYTITLE">tuning</span>(7)</span></a> (a
guide to performance tuning), <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=security&sektion=7&manpath=FreeBSD+8.0-RELEASE">
<span class="CITEREFENTRY"><span class="REFENTRYTITLE">security</span>(7)</span></a> (an
introduction to FreeBSD security), and <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=style&sektion=9&manpath=FreeBSD+8.0-RELEASE">
