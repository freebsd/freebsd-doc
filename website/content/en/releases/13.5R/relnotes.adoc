...
`ena-com` from man:ena[4] has been updated to FreeBSD v2.8.0.
gitref:4691f19ae80e[repository=src].
...
Support of Realtek 8156/8156B was moved from man:dce[4] to man:ure[4].
