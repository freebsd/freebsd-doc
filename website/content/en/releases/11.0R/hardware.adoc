---
title: "FreeBSD 11.0-RELEASE Hardware Notes"
sidenav: download
---
...
This document contains the hardware compatibility notes for FreeBSD 11.0-RELEASE. It lists the hardware platforms supported by FreeBSD, as well as the various types of hardware devices (storage controllers, network interfaces, and so on), along with known working instances of these devices.
...
Intel(R) EM64T is an extended version of IA-32 (x86) and different from Intel(R) IA-64 (Itanium) architecture. Some Intel(R)'s old documentation refers to Intel(R) EM64T as “64-bit extension technology” or “IA-32e”.
...
[i386] The following controllers are supported by the man:da[4] driver:
...
Some onboard CS4610 chips are accompanied by the CS423x ISA codec instead of the CS4297 AC97 codec. Such configurations are not supported by the man:[4] driver yet.
...
The man:[4] driver does _not_ support the following sound cards (although they have names similar to some supported ones):
...
* [amd64, i386] PS/2 keyboards (man:[4] driver)
