---
title: "FreeBSD 11.1-RELEASE Hardware Notes"
sidenav: download
---
...
This document contains the hardware compatibility notes for FreeBSD 11.1-RELEASE. It lists the hardware platforms supported by FreeBSD, as well as the various types of hardware devices (storage controllers, network interfaces, and so on), along with known working instances of these devices.
...
If you have a system that is not listed here, it may not have been tested with FreeBSD 11.1-RELEASE. We encourage you to try it and send a note to the http://lists.FreeBSD.org/mailman/listinfo/freebsd-sparc64[FreeBSD SPARC porting mailing list] with your results, including which devices work and which do not.
