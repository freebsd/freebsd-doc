...
|BETA4 builds begin |26 February 2021 |- |Fourth beta test snapshot.
|RC1 builds begin |5 March 2021 |- |First release candidate.
|RC2 builds begin |12 March 2021 |- |Second release candidate.
|RC3 builds begin * |19 March 2021 |- |Third release candidate.
|RELEASE builds begin |26 March 2021 |- |{localRel}-RELEASE builds begin.
|RELEASE announcement |30 March 2021 |- |{localRel}-RELEASE press release.
