...
A new man:usbhid[4] driver has been added, and can be loaded by adding `hw.usb.usbhid.enable=1` to /boot/loader.conf and adding `usbhid` `to kld_list=""` in /etc/rc.conf. gitref:b62f6dfaed3d[repository=src]
