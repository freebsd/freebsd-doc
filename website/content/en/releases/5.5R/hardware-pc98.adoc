---
title: "FreeBSD/pc98 5.5-RELEASE Hardware Notes"
sidenav: download
---
...
NEC PC-98x1 hardware platform (also referred to as FreeBSD/pc98 5.5-RELEASE). It lists
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=ct&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=snc&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=sb&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
