---
title: "FreeBSD/pc98 5.5-RELEASE Installation Instructions"
sidenav: download
---
...
<p>This article gives some brief instructions on installing FreeBSD/pc98 5.5-RELEASE,
...
(although FreeBSD can run on 386 processors with a custom kernel) and at least 24&nbsp;MB
...
floppy with <tt class="FILENAME">rawrite.exe</tt> under DOS (see the <tt
