---
title: "FreeBSD/ia64 5.5-RELEASE Hardware Notes"
sidenav: download
---
...
<dd>
<dl>
<dt>2.1 <a href="#AEN41">Supported Devices Overview</a></dt>
</dl>
</dd>
...
IA-64 hardware platform (also referred to as FreeBSD/ia64 5.5-RELEASE). It lists devices
...
<div class="SECT2">
<hr />
<h3 class="SECT2"><a id="AEN41" name="AEN41">2.1 Supported Devices Overview</a></h3>
...
<div class="INFORMALTABLE"><a id="AEN58" name="AEN58"></a>
...
<tr>
<td><a
href="http://www.FreeBSD.org/cgi/man.cgi?query=syscons&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
