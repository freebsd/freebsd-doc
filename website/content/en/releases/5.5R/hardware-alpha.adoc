---
title: "FreeBSD/alpha 5.5-RELEASE Hardware Notes"
sidenav: download
---
...
<dt>2.3.6 <a href="#AEN510">AlphaStation 200 (``Mustang'') and 400 (``Avanti'')
series</a></dt>

<dt>2.3.7 <a href="#AEN577">AlphaStation 500 and 600 (``Alcor'' &#38; ``Maverick'' for
EV5, ``Bret'' for EV56)</a></dt>

<dt>2.3.8 <a href="#AEN689">AlphaServer 1000 (``Mikasa''), 1000A (``Noritake'') and
800(``Corelle'')</a></dt>

<dt>2.3.9 <a href="#AEN745">DS10/VS10/XP900 (``Webbrick'') / XP1000 (``Monet'') / DS10L
(``Slate'')</a></dt>

<dt>2.3.10 <a href="#AEN896">DS20/DS20E (``Goldrush'')</a></dt>

<dt>2.3.11 <a href="#AEN965">AlphaPC 264DP / UP2000</a></dt>

<dt>2.3.12 <a href="#AEN1011">AlphaServer 2000 (``DemiSable''), 2100 (``Sable''), 2100A
(``Lynx'')</a></dt>

<dt>2.3.13 <a href="#AEN1082">AlphaServer 4x00 (``Rawhide'')</a></dt>

<dt>2.3.14 <a href="#AEN1115">AlphaServer 1200 (``Tincup'') and AlphaStation 1200
(``DaVinci'')</a></dt>

<dt>2.3.15 <a href="#AEN1145">AlphaServer 8200 and 8400 (``TurboLaser'')</a></dt>

<dt>2.3.16 <a href="#AEN1188">Alpha Processor Inc. UP1000</a></dt>

<dt>2.3.17 <a href="#AEN1237">Alpha Processor Inc. UP1100</a></dt>

<dt>2.3.18 <a href="#AEN1285">Alpha Processor Inc. CS20, Compaq DS20L</a></dt>

<dt>2.3.19 <a href="#AEN1332">Compaq AlphaServer ES40 (``Clipper'')</a></dt>
</dl>
</dd>

<dt>2.4 <a href="#AEN1369">Supported Hardware Overview</a></dt>

<dt>2.5 <a href="#AEN1401">Acknowledgments</a></dt>
</dl>
</dd>
...
<p>This document contains the hardware compatibility notes for FreeBSD 5.5-RELEASE on the
Alpha/AXP hardware platform (also referred to as FreeBSD/alpha 5.5-RELEASE). It lists
...
accommodate large to very large physical memory sizes, FreeBSD is limited to 1 or 2
Gbytes (dependent on the core chipset) of RAM. This restriction is due to the current
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=pcm&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN510" name="AEN510">2.3.6 AlphaStation 200 (``Mustang'') and
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN577" name="AEN577">2.3.7 AlphaStation 500 and 600 (``Alcor''
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN689" name="AEN689">2.3.8 AlphaServer 1000 (``Mikasa''), 1000A
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN745" name="AEN745">2.3.9 DS10/VS10/XP900 (``Webbrick'') /
...
<div class="SECT4">
<hr />
<h5 class="SECT4"><a id="AEN751" name="AEN751">2.3.9.1 ``Webbrick / Slate''</a></h5>
...
mandatory to keep <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=config&amp;sektion=8&amp;manpath=FreeBSD+5.5-RELEASE">
...
<div class="SECT4">
<hr />
<h5 class="SECT4"><a id="AEN816" name="AEN816">2.3.9.2 ``Monet''</a></h5>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN896" name="AEN896">2.3.10 DS20/DS20E (``Goldrush'')</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN965" name="AEN965">2.3.11 AlphaPC 264DP / UP2000</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1011" name="AEN1011">2.3.12 AlphaServer 2000 (``DemiSable''),
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1082" name="AEN1082">2.3.13 AlphaServer 4x00
(``Rawhide'')</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1115" name="AEN1115">2.3.14 AlphaServer 1200 (``Tincup'') and
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1145" name="AEN1145">2.3.15 AlphaServer 8200 and 8400
(``TurboLaser'')</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1188" name="AEN1188">2.3.16 Alpha Processor Inc.
UP1000</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1237" name="AEN1237">2.3.17 Alpha Processor Inc.
UP1100</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1285" name="AEN1285">2.3.18 Alpha Processor Inc. CS20, Compaq
DS20L</a></h4>
...
<div class="SECT3">
<hr />
<h4 class="SECT3"><a id="AEN1332" name="AEN1332">2.3.19 Compaq AlphaServer ES40
(``Clipper'')</a></h4>
...
<div class="SECT2">
<hr />
<h3 class="SECT2"><a id="AEN1369" name="AEN1369">2.4 Supported Hardware Overview</a></h3>
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=de&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
<span class="CITEREFENTRY"><span class="REFENTRYTITLE">de</span>(4)</span></a> (older
driver) or <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=dc&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
<div class="SECT2">
<hr />
<h3 class="SECT2"><a id="AEN1401" name="AEN1401">2.5 Acknowledgments</a></h3>
...
$FreeBSD: src/release/doc/en_US.ISO8859-1/hardware/common/dev.sgml,v 1.227.2.35
2006/03/12 23:43:59 rik Exp $
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=cd&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=sf&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
<p>Adapters supported by the <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=rl&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=wb&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=vr&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
<p>Adapters supported by the <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=sk&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=tl&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=em&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
...
82543, 82544, 82545, 82546, 82546EB, 82546GB and 82547 controller chips:</p>
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=gx&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
<span class="CITEREFENTRY"><span class="REFENTRYTITLE">gx</span>(4)</span></a> driver
supports Gigabit Ethernet adapters based on the Intel 82542 and 82543 controller
chips:</p>
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=re&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
<span class="CITEREFENTRY"><span class="REFENTRYTITLE">re</span>(4)</span></a> driver
supports RealTek RTL8139C+, RTL8169, RTL8169S and RTL8110S based Fast Ethernet and
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=rp&amp;sektion=4&amp;manpath=FreeBSD+5.5-RELEASE">
