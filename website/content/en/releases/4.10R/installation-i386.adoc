---
title: "FreeBSD/i386 4.10-RELEASE Installation Instructions"
sidenav: download
---
...
<p>This article gives some brief instructions on installing FreeBSD/i386 4.10-RELEASE,
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=doscmd&sektion=1&manpath=FreeBSD+4.10-RELEASE">
