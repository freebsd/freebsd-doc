...
If you have a system that is not listed here, it may not have been tested with FreeBSD 10.4-RELEASE. We encourage you to try it and send a note to the http://lists.FreeBSD.org/mailman/listinfo/freebsd-sparc64[FreeBSD SPARC porting mailing list] with your results, including which devices work and which do not.
...
Controllers supported by the man:aacraid[4] driver include:
...
The man:cxgbe[4] driver supports 40Gb, 10Gb and 1Gb Ethernet adapters based on the T5 ASIC (ports will be named cxl):
...
The man:ixl[4] driver supports 10Gb and 1Gb Ethernet adapters with SR Modules:

* Intel DUAL RATE 1G/10G SFP+ SR (bailed) FTLX8571D3BCV-IT
* Intel DUAL RATE 1G/10G SFP+ SR (bailed) AFBR-703SDZ-IN2

The man:ixl[4] driver supports 10Gb and 1Gb Ethernet adapters with LR Modules:
...
The man:urtwn[4] driver supports Realtek RTL8188CU/RTL8188EU/RTL8192CU based USB IEEE 802.11b/g/n wireless network adapters, including:
...
[pc98] Creative Technologies SoundBlaster(98) (man:b[4] driver)
