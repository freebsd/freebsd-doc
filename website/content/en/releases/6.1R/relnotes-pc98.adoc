...
<title>FreeBSD/pc98 6.1-RELEASE Release Notes</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD/pc98 6.1-RELEASE Release
Notes</a></h1>
...
<p>This document contains the release notes for FreeBSD 6.1-RELEASE on the NEC PC-98x1
