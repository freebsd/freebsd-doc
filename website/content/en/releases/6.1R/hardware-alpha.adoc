...
<title>FreeBSD/alpha 6.1-RELEASE Hardware Notes</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD/alpha 6.1-RELEASE Hardware
Notes</a></h1>
...
Alpha/AXP hardware platform (also referred to as FreeBSD/alpha 6.1-RELEASE). It lists
