---
title: "FreeBSD 11.2-RELEASE Hardware Notes"
sidenav: download
---
...
If you have a system that is not listed here, it may not have been tested with FreeBSD 11.2-RELEASE. We encourage you to try it and send a note to the http://lists.FreeBSD.org/mailman/listinfo/freebsd-sparc64[FreeBSD SPARC porting mailing list] with your results, including which devices work and which do not.
