---
title: "FreeBSD 14.5-RELEASE Errata"
sidenav: download
---
...
1. Systems with **frequently changing routing tables**, such as BGP routers, that use the default algorithms may experience system instability due to a memory leak. This does not affect systems where alternative routing algorithms have been explicitly configured. +
