...
Based on the new FreeBSD support model, the FreeBSD 13 release series will be supported until at least {thisEOL}. This point release, FreeBSD {thisRelease}-RELEASE, will be supported until the end of life of FreeBSD {thisRelease}-RELEASE. Additional support information can be found at:
