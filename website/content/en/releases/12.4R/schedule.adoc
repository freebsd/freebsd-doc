...
|RC1 builds begin |4 November 2022 |- |First release candidate.
|RC2 builds begin |11 November 2022 |- |Second release candidate.
|RC3 builds begin* |18 November 2022 |- |Third release candidate.
|RELEASE builds begin |30 November 2022 |- |{localRel}-RELEASE builds begin.
|RELEASE announcement |5 December 2022 |- |{localRel}-RELEASE press release.
