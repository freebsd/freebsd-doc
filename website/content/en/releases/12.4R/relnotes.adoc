...
The man:sendmail[8] had a bug fixed about authentication with cyrus-sasl-2.1.28.
...
The man:telnet[1] now silently ignores invalid `set ' '` and invalid `help help` commands instead of having a segmentation fault.

The man:telnetd[1] daemon has been deprecated.

The man:telnet[1] had CVE-2020-39028 fixed.

The man:telnet[1] had CVE-2020-10188 fixed.
