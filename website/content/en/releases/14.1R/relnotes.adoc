...
gitref:d692c314d29a[repository=src]
...
Hot unlugging of sound devices is now handled, closing the device immediately.
...
ARP (man:arp[4]) support for 802-standard networks has been restored; it had been accidentally removd with FDDI support.
