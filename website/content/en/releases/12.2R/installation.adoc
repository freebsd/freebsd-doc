---
title: "FreeBSD 12.2-RELEASE Installation Instructions"
sidenav: download
---
...
The {{< manpage "freebsd-update" "8">}} utility supports binary upgrades of i386 and amd64 systems running earlier FreeBSD releases. Systems running 11.4-RELEASE or 12.1-RELEASE can upgrade as follows:
