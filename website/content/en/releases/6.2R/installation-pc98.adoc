---
title: "FreeBSD/pc98 6.2-RELEASE Installation Instructions"
sidenav: download
---
...
<p>This article gives some brief instructions on installing FreeBSD/pc98 6.2-RELEASE,
...
<div class="SECT2">
<hr />
<h3 class="SECT2"><a id="AEN846" name="AEN846">4.2 Common Installation Problems for NEC
PC-98x1 Architecture Users</a></h3>
</div>
</div>
</div>
