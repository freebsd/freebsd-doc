---
title: "FreeBSD/pc98 6.2-RELEASE Hardware Notes"
sidenav: download
---
...
NEC PC-98x1 hardware platform (also referred to as FreeBSD/pc98 6.2-RELEASE). It lists
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=ct&sektion=4&manpath=FreeBSD+6.2-RELEASE"><span
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=snc&sektion=4&manpath=FreeBSD+6.2-RELEASE">
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=sb&sektion=4&manpath=FreeBSD+6.2-RELEASE"><span
