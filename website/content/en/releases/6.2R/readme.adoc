...
<title>FreeBSD 6.2-RELEASE README</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD 6.2-RELEASE README</a></h1>
...
<p>This document gives a brief introduction to FreeBSD 6.2-RELEASE. It includes some
...
<p>This distribution is a release of FreeBSD 6.2-RELEASE, the latest point along the
6.2-STABLE branch.</p>
...
software, with a single command. Over 16,000 ports, from editors to programming languages
...
<p>If you're tracking the 6.2-STABLE development efforts, you <span class="emphasis"><i
...
different in FreeBSD 6.2-RELEASE compared to the previous release (FreeBSD
6.1-RELEASE).</p>
</li>
