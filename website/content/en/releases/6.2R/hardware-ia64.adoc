...
<title>FreeBSD/ia64 6.2-RELEASE Hardware Notes</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD/ia64 6.2-RELEASE Hardware
Notes</a></h1>
...
IA-64 hardware platform (also referred to as FreeBSD/ia64 6.2-RELEASE). It lists devices
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=syscons&sektion=4&manpath=FreeBSD+6.2-RELEASE">
...
<ul>
<li>
<p>Diva Serial (GSP) Multiport UART</p>
</li>
</ul>
