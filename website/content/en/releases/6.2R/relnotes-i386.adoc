...
<title>FreeBSD/i386 6.2-RELEASE Release Notes</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD/i386 6.2-RELEASE Release
Notes</a></h1>
...
<p>This document contains the release notes for FreeBSD 6.2-RELEASE on the i386 hardware
...
<p>A bug in the i386 boot loader, which could cause filesystem corruption if a <tt
class="FILENAME">nextboot.conf</tt> file was used and landed after cylinder 1023, has
been fixed.</p>
</div>
...
<p>Support has been improved for so-called &#8220;legacy-free&#8221; hardware, in
particular, i386 systems without AT-style keyboard controllers such as the Macbook
Pro.</p>
