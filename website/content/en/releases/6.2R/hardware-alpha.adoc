---
title: "FreeBSD/alpha 6.2-RELEASE Hardware Notes"
sidenav: download
---
...
<p>This document contains the hardware compatibility notes for FreeBSD 6.2-RELEASE on the
Alpha/AXP hardware platform (also referred to as FreeBSD/alpha 6.2-RELEASE). It lists
...
mandatory to keep <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=config&sektion=8&manpath=FreeBSD+6.2-RELEASE">
...
$FreeBSD: src/release/doc/en_US.ISO8859-1/hardware/common/dev.sgml,v 1.282.2.12
2006/08/08 09:52:31 brueffer Exp $
