---
title: "FreeBSD/alpha 6.3-RELEASE Hardware Notes"
sidenav: download
---
...
Alpha/AXP hardware platform (also referred to as FreeBSD/alpha 6.3-RELEASE). It lists
...
mandatory to keep <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=config&sektion=8&manpath=FreeBSD+6.3-RELEASE">
