---
title: "FreeBSD/sparc64 6.3-RELEASE Hardware Notes"
sidenav: download
---
...
UltraSPARC hardware platform (also referred to as FreeBSD/sparc64 6.3-RELEASE). It lists
...
6.3-RELEASE. We encourage you to try it and send a note to the <a
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=esp&sektion=4&manpath=FreeBSD+6.3-RELEASE">
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=snd_audiocs&sektion=4&manpath=FreeBSD+6.3-RELEASE">
