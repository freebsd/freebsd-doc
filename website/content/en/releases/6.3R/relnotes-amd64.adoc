...
<title>FreeBSD/amd64 6.3-RELEASE Release Notes</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD/amd64 6.3-RELEASE Release
Notes</a></h1>
...
<p>This document contains the release notes for FreeBSD 6.3-RELEASE on the AMD64 hardware
