...
<html>
  <head>
    ...
    <title>FreeBSD/alpha 4.6.2-RELEASE Hardware Notes</title>
  ...
  "#0000FF" vlink="#840084" alink="#0000FF">
    <div class="ARTICLE">
      <div class="TITLEPAGE">
        <h1 class="TITLE"><a name="AEN2">FreeBSD/alpha
        4.6.2-RELEASE Hardware Notes</a></h1>
      ...
      <div class="SECT1">
        ...
        for FreeBSD 4.6.2-RELEASE on the Alpha/AXP hardware
        platform (also referred to as FreeBSD/alpha 4.6.2-RELEASE).
        It lists devices known to work on this platform, as well as
