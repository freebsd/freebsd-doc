...
|BETA5 builds begin |6 October 2023 |- |Fourth beta test snapshot.
|RC1 builds begin |13 October 2023 |- |First release candidate.
|RC2 builds begin |20 October 2023 |- |Second release candidate.
|RC3 builds begin* |27 October 2023 |- |Third release candidate.
|RELEASE builds begin |3 November 2023 |- |{localRel}-RELEASE builds begin.
|RELEASE announcement |7 November 2023 |- |{localRel}-RELEASE press release.
