---
title: FreeBSD 14.3 Hardware Notes
sidenav: download
---
...
The man:qat[4] driver supports the following
Intel QuickAssist Technology Engines:

*	Intel C62x Chipset
*	Intel Atom C3000 processor product family
*	Intel QuickAssist Adapter 8960 "Lewis Hill"
*	Intel QuickAssist Adapter 8970 "Lewis Hill"
