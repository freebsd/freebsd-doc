...
1. **man:freebsd-update[8]** fetch and other commands have no effect. +
**Workaround**: run `pkg bootstrap` for base man:pkg[7] to bootstrap man:pkg[8] from the ports collection. +
**State**: open -- https://bugs.freebsd.org/293516[bug 293516]. +
