...
|link:https://www.FreeBSD.org/security/advisories/FreeBSD-EN-26:21.openssl.asc[FreeBSD-EN-26:21.openssl] |25 August 2026 |OpenSSL pkg-config files contain incorrect versions
|===
...
**State**: Fixed in {releaseBranch} after 16 June 2026 - https://bugs.freebsd.org/293654 +
