...
<ul>
  <li><a href="todo.html" shape="rect">FreeBSD 7.0 developer todo list.</a></li>
  <li><a href="approvals.html" shape="rect">FreeBSD 7.0 Code Freeze Commit Approval List.</a></li>
