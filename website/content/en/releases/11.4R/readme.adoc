...
* [.filename]`RELNOTES.TXT`: The release notes, showing what's new and different in FreeBSD 11.4-RELEASE compared to the previous release (FreeBSD 11.2-RELEASE).
