---
title: "FreeBSD 10.0-RELEASE Hardware Notes"
sidenav: download
---
...
The http://www.FreeBSD.org/cgi/man.cgi?query=snd_emu10kx&sektion=4[snd_emu10kx(4)] driver does _not_ support the following sound cards (although they have names similar to some supported ones):
