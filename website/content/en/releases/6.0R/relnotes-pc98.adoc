---
title: "FreeBSD/pc98 6.0-RELEASE Release Notes"
sidenav: download
---
...
<p>This document contains the release notes for FreeBSD 6.0-RELEASE on the NEC PC-98x1
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=wd&sektion=4&manpath=FreeBSD+6.0-RELEASE"><span
 class="CITEREFENTRY"><span class="REFENTRYTITLE">wd</span>(4)</span></a> driver has been
removed. The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=ata&sektion=4&manpath=FreeBSD+6.0-RELEASE">
<span class="CITEREFENTRY"><span class="REFENTRYTITLE">ata</span>(4)</span></a> driver
has been found to work well enough on the pc98 platform that there is no need for the
older <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=wd&sektion=4&manpath=FreeBSD+6.0-RELEASE"><span
 class="CITEREFENTRY"><span class="REFENTRYTITLE">wd</span>(4)</span></a> driver.</p>
