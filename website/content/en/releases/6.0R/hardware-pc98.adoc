...
<title>FreeBSD/pc98 6.0-RELEASE Hardware Notes</title>
...
<div class="ARTICLE">
<div class="TITLEPAGE">
<h1 class="TITLE"><a id="AEN2" name="AEN2">FreeBSD/pc98 6.0-RELEASE Hardware
Notes</a></h1>
...
NEC PC-98x1 hardware platform (also referred to as FreeBSD/pc98 6.0-RELEASE). It lists
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=ct&sektion=4&manpath=FreeBSD+6.0-RELEASE"><span
...
<p>The <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=snc&sektion=4&manpath=FreeBSD+6.0-RELEASE">
...
href="http://www.FreeBSD.org/cgi/man.cgi?query=sb&sektion=4&manpath=FreeBSD+6.0-RELEASE"><span
