...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:db="http://docbook.org/ns/docbook">
  <head>
    <title>FreeBSD 6.0 Release Process</title>
  ...
  <a href="#contentwrap" title="Skip section navigation" accesskey="2">Skip section navigation</a> (2)
        ...
        <div id="content">
          ...
          <div id="contentwrap"><h1>FreeBSD 6.0 Release Process</h1>
...
<ul>
  <li><a href="todo.html" shape="rect">FreeBSD 6.0 developer todo list.</a></li>
  <li><a href="approvals.html" shape="rect">FreeBSD 6.0 Code Freeze Commit Approval List.</a></li>
