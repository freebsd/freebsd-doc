---
title: "FreeBSD/i386 6.0-RELEASE Release Notes"
sidenav: download
---
...
<p>This document contains the release notes for FreeBSD 6.0-RELEASE on the i386 hardware
...
<p>Support for 80386 processors (the <tt class="LITERAL">I386_CPU</tt> kernel
configuration option) has been removed. Users running this class of CPU should use
FreeBSD 5.<tt class="REPLACEABLE"><i>X</i></tt> or earlier.</p>
...
devices which do not have their memory assigned by the BIOS. This change fixes the
&#8220;bad Vcc&#8221; error of CardBus bridges (<a
href="http://www.FreeBSD.org/cgi/man.cgi?query=pccbb&sektion=4&manpath=FreeBSD+6.0-RELEASE">
<span class="CITEREFENTRY"><span class="REFENTRYTITLE">pccbb</span>(4)</span></a>).
[MERGED]</p>
...
specifying <tt class="FILENAME">/boot/boot0sio</tt> as the argument to the <code
class="OPTION">-b</code> option.</p>
...
<p>Support for the OLDCARD subsystem has been removed. The NEWCARD system is now used for
all PCCARD device support.</p>
...
driver now supports VESA (15, 16, 24, and 32 bit) modes. To enable this feature, two
kernel options <tt class="LITERAL">SC_PIXEL_MODE</tt> and <tt class="LITERAL">VESA</tt>
(or corresponding kernel module) are needed.</p>
...
<p>Read-only support for ReiserFS version 3 has been added. See <a
href="http://www.FreeBSD.org/cgi/man.cgi?query=mount_reiserfs&sektion=8&manpath=FreeBSD+6.0-RELEASE">
<span class="CITEREFENTRY"><span
class="REFENTRYTITLE">mount_reiserfs</span>(8)</span></a> for details.</p>
</div>
