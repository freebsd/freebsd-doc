---
title: "FreeBSD/sparc64 5.4-RELEASE Hardware Notes"
sidenav: download
---
...
UltraSPARC hardware platform (also referred to as FreeBSD/sparc64 5.4-RELEASE). It lists
...
5.4-RELEASE. We encourage you to try it and send a note to the <a
