---
title: "FreeBSD/i386 5.4-RELEASE Installation Instructions"
sidenav: download
---
...
<p>This article gives some brief instructions on installing FreeBSD/i386 5.4-RELEASE,
...
FreeBSD can run on 386 processors with a custom kernel) and at least 24&nbsp;MB of RAM.
You will need at least 150MB of free hard drive space for the most minimal installation.
See below for ways of shrinking existing DOS partitions in order to install FreeBSD.</p>
...
<div class="SECT2">
<hr />
<h3 class="SECT2"><a id="AEN473" name="AEN473">1.6 Question and Answer Section for i386
...
<div class="SECT2">
<hr />
<h3 class="SECT2"><a id="AEN844" name="AEN844">4.2 Common Installation Problems for i386
Architecture Users</a></h3>
