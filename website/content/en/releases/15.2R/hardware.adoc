---
title: FreeBSD 15.2 Hardware Notes
sidenav: download
---
...
The
man:mrsas[4]
driver supports the following Broadcom/LSI SATA/SAS RAID controllers:
...
based on the DisplayLink DL-120 and DL-160 graphic chips, including:
