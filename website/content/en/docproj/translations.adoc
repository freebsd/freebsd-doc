...
*E-Mail*: qwertiox.kontakt@gmail.com

Documents currently being worked on:

* link:https://docs.freebsd.org/pl/books/developers-handbook/[Developers' Handbook]
* link:https://docs.freebsd.org/pl/articles/[Some articles]
