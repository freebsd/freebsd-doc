...
** link:{url-rel}/arm64/aarch64/ISO-IMAGES/{rel130-current}/[RPI3]
* armv6/armv7
* {blank}
...
* https://ghostbsd.org[GhostBSD] is derived from FreeBSD, GhostBSD uses the GTK environment to provide beautiful looks and a comfortable experience on the modern BSD platform offering a natural and native &unix; work environment.
