...
While FreeBSD does not gather deployment statistics, having statistical information available is essential.
Please consider installing the https://www.freshports.org/sysutils/bsdstats/[sysutils/bsdstats] package, which collects hardware and software statistics, helping developers understand how to best focus their efforts.
The information collected is available at the http://bsdstats.org[bsdstats.org] website.
