...
. Configuration files and installation commands are generated using a variety of interactive interfaces.
. The actual system installation is executed based on the previously created files.
