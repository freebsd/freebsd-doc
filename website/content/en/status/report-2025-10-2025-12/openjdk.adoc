...
* https://reviews.freebsd.org/D53326[Released a port] for OpenJDK 25, later https://reviews.freebsd.org/D53975[updated to OpenJDK 25.0.1]. Thanks to Greg Lewis and Kurt Miller for helping.
