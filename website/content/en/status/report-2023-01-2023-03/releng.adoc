...
As of this writing, the 13.2 cycle has followed the set schedule, with the addition of a fourth and fifth RC build at the end, postponing the final release from the end of March to early April.
