...
ifdef::reports-path[]
<<_endpoint_independent_nat,Endpoint-Independent NAT>>
endif::[]
ifndef::reports-path[]
link:../eim-nat[Endpoint-Independent NAT]
endif::[]
report entry.
...
entry for the latest news.

* Olivier Certner has two entries in this report.
  You can read about his latest work in the
ifdef::reports-path[]
<<_scheduling_priorities_256_queue_runqueues_sub_project,Scheduling Priorities: 256-queue Runqueues Sub-Project>>
endif::[]
ifndef::reports-path[]
link:../sched_prio-256_queue_runqueue[Scheduling Priorities: 256-queue Runqueues Sub-Project]
endif::[]
and
ifdef::reports-path[]
<<_mac_do4_setcred2_mdo1,mac_do(4), setcred(2), mdo(1)>>
endif::[]
ifndef::reports-path[]
link:../mac_do[mac_do(4), setcred(2), mdo(1)]
endif::[]
report entries.

* Bjoern Zeeb continued to improve wireless networking on FreeBSD.
  You can read the latest news in Bjoern's 
ifdef::reports-path[]
<<_wireless_update,Wireless Update>>
endif::[]
ifndef::reports-path[]
link:../wireless[Wireless Update]
endif::[]
entry.
...
entry for the latest information.
