...
link:https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=293559[Issue 293559]
...
Building on the grounwork of moving ports to OpenJDK 21 the switch of JAVA_DEFAULT to 25 is a much smaller step.
Most Java ports compile and run without changes. Only a handful of ports need some fixes, which is currently in progress.
