...
ifndef::reports-path[]
* link:../vision-accessibility[Vision Accessibility]
...
* link:../pkgbase-bsdinstall[Support for pkgbase in the FreeBSD Installer]
* link:../drm-drivers[DRM drivers]
* link:../mit_krb5[MIT Kerberos Import into FreeBSD]
* link:../usb-debugging[USB Kernel Debugging]
* link:../bugmeister[Bugmeister Team]
endif::[]
