...
For background information about both major projects, refer to the 2025Q1 quarterly status report.
...
** implemented initial support for man:pf[4]-based NAT networking (under review)
