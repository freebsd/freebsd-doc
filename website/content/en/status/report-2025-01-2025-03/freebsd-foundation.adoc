...
ifdef::reports-path[]
<<_infrastructure_modernization,Infrastructure Modernization report entry>>.
endif::[]
ifndef::reports-path[]
link:../foundation-infrastructure-modernization[Infrastructure Modernization report entry].
endif::[]
