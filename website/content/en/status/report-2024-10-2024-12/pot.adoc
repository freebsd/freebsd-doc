...
Potluck got a new link:https://github.com/bsdpot/potluck/tree/master/netbox[Netbox] image. Additionally, all images have been rebuilt several times: For FreeBSD 14.1, to include security fixes, then again for 14.2 and last not least for the new quarterly packages. 
