...
ifdef::reports-path[]
<<_ports_collection_accessibility_colors_low_vision,FreeBSD Accessibility Project update>>.
endif::[]
ifndef::reports-path[]
link:../ports-collection-accessibility-colors[FreeBSD Accessibility Project update].
endif::[]
* mailto:obiwac@FreeBSD.org[Aymeric Wibo] began implementing
ifdef::reports-path[]
<<_suspendresume_improvements,suspend-to-idle and S0ix sleep support>>.
endif::[]
ifndef::reports-path[]
link:../suspend[suspend-to-idle and S0ix sleep support].
endif::[]
* mailto:bz@FreeBSD.org[Bjoern A. Zeeb] shared a
ifdef::reports-path[]
<<_linuxkpi_802_11_wireless_update, LinuxKPI 802.11 Wireless Update>>.
endif::[]
ifndef::reports-path[]
link:../lkpi-wireless[LinuxKPI 802.11 Wireless Update].
endif::[]
