...
* link:../pkgbase-install[Support for Installing pkgbase Systems]
...
* link:../sta-wpc-ci-automation[STA Work Package C: CI/CD Automation]
...
ifndef::reports-path[]
* link:../ACPI[ACPI Lua Bindings]
* link:../sockstat[Sockstat UI Improvements]
* link:../geomman[Geomman Release]
* link:../mac_do[mac_do(4) and mdo(1) Improvements]
link:../foundation-sta[infrastructure modernization project]
endif::[]
