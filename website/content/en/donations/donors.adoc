...
|bms |Time Appliances TimeNIC I226-V 1PPS SMA | mike@sentex.net (for network test cluster)
|bms |Mobility Electronics PCI-to-Cardbus Bridge | imp
|Francesco Caruso <indirizzopoi@proton.me> |1x Raxda E54C |mikael
|Francesco Caruso <indirizzopoi@proton.me> |1x OrangePi RV2 |des
